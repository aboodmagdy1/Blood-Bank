    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center">
                ...
                <div class="ms-3 sm:ms-10">
                    <x-nav-link class="nav-link" data-widget="pushmenu" href="#" role="button">
            ...
            <div class="hidden sm:flex items-center space-x-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
