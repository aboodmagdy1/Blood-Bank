        ...
        <x-table>
            ...
            <x-slot name='tbody'>
                ...
                <tr>
                    ...
                    <th>
                        <a href="{{route('permissions.edit',$record->id)}}" class="btn btn-info">Edit</a>
                        <form action="{{route('permissions.destroy',$record->id)}}" method="POST" style="display:inline-block">
                            @csrf
                            @method('DELETE')
